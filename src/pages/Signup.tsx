...
import LoginIcon from '../assets/로그인.svg?react';
            ...
            <div className="w-1/2 h-full flex flex-1 flex-col items-center">
                <div className="w-[80%] h-full flex flex-col justify-center">
                    ...
                    <div className="flex flex-col mt-7 space-y-6">
                        <Input label="이름" type="name" placeholder="이름을 입력하세요" />
                        <div className="flex flex-col space-y-0 ">
                            <div className="flex flex-row">
                                <Input className="w-full" label="전화번호" type="tel" placeholder="01012345678" />
                                <button className="w-[25%] h-[48px] bg-[#FB6091] text-sm text-white opacity-30 rounded-[6px] mt-8 ml-3">
                                    인증번호 발송
                                </button>
                            </div>
                            <div className="flex flex-row">
                                <Input className="w-full" label="" type="text" placeholder="인증번호를 입력하세요" />
                        ...
                        <div className="flex flex-row">
                            <Input className="w-full" label="이메일" type="email" placeholder="example@gmail.com" />
                            <button className="w-[25%] h-[48px] bg-[#FB6091] text-sm text-white opacity-30 rounded-[6px] mt-8 ml-3">
                                이메일 인증
                            </button>
                        </div>
